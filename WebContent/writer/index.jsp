...
<%@ include file = "header_original.jsp" %>
	...
	<div class="slider-area">
		...
		<!-- slider Area End-->
		<h1 style="font-size: 36px;text-align: center;color: #FD9F28;">더욱 더 특별하게 영화를 즐길 수 있는 3가지 방법</h1>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="single-shop-info">
							...
							<div class="shop-info-content">
								<h2>나의 리뷰</h2>
								<p>영화를 보고 난 후<br>그때의 느낌, 생각, 분위기를<br> 나만의 공간에 기록해보세요</p>
								<a href="#">나만의 리뷰 작성하러 가기</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="single-shop-info">
							...
							<div class="shop-info-content">
								<h2>모두의 리뷰</h2>
								<p>다른 사람들은 어떤 영화를 봤을지, 나와 다른 어떤 생각을 했을지 <br>경험해보세요</p>
								<a href="#">다른 사람의 리뷰 보러가기</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 hidden-sm">
						<div class="single-shop-info">
							...
							<div class="shop-info-content">
								<h2>토론방</h2>
								<p>같은 영화를 보고 그 때 그 장면, <br>그 때 그 대사에 대해<br>의견을 나누어 보세요</p>
								<a href="#">&nbsp;토론 하러 가기&nbsp;</a>
							</div>
						</div>
					</div>
					...
					<div class="banner-list">
						<div class="col-md-4 col-sm-6">
							<div class="single-banner">
								...
								<div class="banner-bottom text-center" style="font-family: 'S-CoreDream-4Regular'">
								<span>결백<br>The innocence</span><br>
										<span>NEW RELEASE 2020.06.11</span>
								</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-6">
							<div class="single-banner">
								<a href="#"> <img src="img/banner/2.jpg" alt=""><!-- 결백 -->
								</a>
								<div class="banner-bottom text-center" style="font-family: 'S-CoreDream-4Regular'">
									<span>언더워터<br>Underwater</span><br>
									<span>NEW RELEASE 2020.05.27</span><!-- 언더워터 -->
								</div>
							</div>
						</div>
						<div class="col-md-4 hidden-sm">
							<div class="single-banner">
								<a href="#"> <img src="img/banner/3.jpg" alt=""><!-- 에어로너츠 -->
								</a>
								<div class="banner-bottom text-center" style="font-family: 'S-CoreDream-4Regular'">
								<span>에어로너츠<br>The Aeronauts</span><br>
									<span>NEW RELEASE 2020.06.10</span>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="testimonial-area text-center">
			<div class="container">
				<div class="testimonial-title">
					...
					<p>지금 SHAREVIEW를 이용하고 있는 회원들이 이런 점을 추천해요!</p>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="testimonial-list">
							<div class="single-testimonial">
								...
								<div class="testmonial-info clearfix">
									<p>평소에도 영화를 보고나서 감상을 적어놓는 걸 좋아해요! <br>다른 영화 리뷰 사이트는 본격적으로 길게 적지 않으면 안되는 곳이 많은데,  
									SHAREVIEW는 별점만 남기는 것도 가능하고, <br>간단히 짧은 문장으로도 기록할 수 있어 정말 좋아요!</p>
							...
							<div class="single-testimonial">
								...
								<div class="testmonial-info clearfix">
									<p>영화를 보고나서 영화에 숨겨져 내포 되어 있는 의미나, <br>해석을 찾아보는 것을 좋아합니다.<br>
									 SHAREVIEW에서는
									영화에 대한 다양한 해석이나 감상을 영화를 본 다른 사람들과도 의견을 나눌 수 있는 점이 가장 맘에 듭니다!</p>
									<div class="testimonial-author text-center">
										<h3>JAEHEE</h3>
										<p>대학생</p>
									</div>
						...
						<div class="col-md-3">
							<div class="single-blog">
								...
								<div class="blog-info text-center">
									<a href="#"><h2>Modern Book Reviews</h2></a>
									<div class="blog-info-bottom">
										<span class="blog-author">BY: <a href="#">ZARIF
												SUNI</a></span> <span class="blog-date">19TH JAN 2016</span>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter-title">
							...
							<p>SHAREVIEW를 구독하시고 다양한 정보를 받아보세요!</p>
						</div>
							...
							<div class="footer-left">
								...
								<ul class="footer-contact">
									<li><i class="flaticon-location"></i> 450 fifth Avenue,
										34th floor. NYC</li>
									<li><i class="flaticon-technology"></i> (+800) 123 4567
										890</li>
