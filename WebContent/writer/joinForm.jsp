...
<title>SHAREVIEW | REGISTER</title>
	...
	<div class="login-account section-padding">
		<div class="container">
			<div class="row">
				<div class="col-md-11 col-sm-6">
					<form action="#" class="create-account-form" method="post">
						...
						<p>비밀번호 입력</p>
						<p class="form-row">
							<input type="email" placeholder="비밀번호를 입력하세요">
						</p>
						<p>비밀번호 확인</p>
						<p class="form-row">
						<input type="password" placeholder="비밀번호 확인을 입력하세요">
						</p>
						<p>이름 (필수)</p>
						<p class="form-row">
			...
			<input type="radio" name="gender" value="여" checked><span>   여자</span>
						...
						<div class="submit">
							<button name="joincreate" id="joincreate2" type="submit"
								class="joincreate">
