                                 ...
                                 <!-- 정보 추가 -->
                                 	...
                                 	<div class="panel-body">
											<div class="coupon-info">
													<img class="author_img rounded-circle" src="img/blog/author.png" alt="" id="img1">
													<p></p>	
													<h3 id="font1">코코</h3>
													<p id = "font1">영화를 사랑하는 사람</p>
													<span id = "font1">팔로워 :  1 명 </span> &nbsp;&nbsp; <span id = "font1">팔로잉 :  1 명 </span>
													<p></p>
													<p>게시물 : 1개</p>
                                        ...
                                        <div class="col-md-4 col-sm-6">
											<div class="single-banner">
												<div class="product-wrapper">
													<a href="board_view.jsp" class="single-banner-image-wrapper">
												...
												<div class="banner-bottom text-center">
													<div class="banner-bottom-title">
														<a href="board_view.jsp">East of eden</a>
													</div>
